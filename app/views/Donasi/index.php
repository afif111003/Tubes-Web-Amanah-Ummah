        ...
        foreach( $data['pnr'] as $pnr) : ?><tr>
          ...
          <td align="center">
            <?php if($pnr['status_validasi']=='0') {?>
                <!-- <a href="<?= BASEURL; ?>/Masjid/hapus/<?= $pnr['id_masjid']?>" class="btn btn-danger btn-sm" onclick="return confirm('Data ini akan dihapus permanen');"> --><button class="btn btn-danger btn-sm" style="width: 100px">Ditolak</button>
            <?php }elseif($pnr['status_validasi']=='1') {?>
                <!-- <a href="<?= BASEURL; ?>/Masjid/hapus/<?= $pnr['id_masjid']?>" class="btn btn-success btn-sm" onclick="return confirm('Data ini akan dihapus permanen');"> --><button class="btn btn-success btn-sm" style="width: 100px">Diterima</button>
            <?php }elseif($pnr['status_validasi']=='2') {?>
                <!-- <a href="<?= BASEURL; ?>/Masjid/hapus/<?= $pnr['id_masjid']?>" class="btn btn-warning btn-sm" onclick="return confirm('Data ini akan dihapus permanen');"> --><button class="btn btn-warning btn-sm" style="width: 100px">Belum Validasi</button>
            <?php } ?>
        </td>
