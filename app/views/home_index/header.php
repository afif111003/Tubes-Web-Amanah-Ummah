...
<head>
    ...
    <!-- favicon
    ============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="<?= BASEURL; ?>/assets_web/img/Logoku1.png">
    <!-- Google Fonts
    ============================================ -->
        ...
        <div class="left-sidebar-pro">
            <nav id="sidebar">
                <div class="sidebar-header">
                    <a href="#"><img src="<?=BASEURL;?>/assets/img/message/Logoku1.png" alt="" />
                    </a>
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item">
                            <a href="<?=BASEURL;?>/Masjid"><i class="fa big-icon fa-building"></i> <span class="mini-dn">Masjid</span> <span class="indicator-right-menu mini-dn"></span></a>
                        </li>
