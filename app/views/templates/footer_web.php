<!-- footer_start  -->
                    ...
                    <div class="col-xl-6 col-md-6 col-lg-6 ">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <img src="<?= BASEURL; ?>/assets_web/img/Logoku1.png" alt="">
                                </a>
                            </div>
                            <p class="address_text">Badan Amil Zakat Amanah Ummah
                            </p>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="address_line">
                                <li>+62 811-3278-005</li>
                                <li><a href="#">TelkomUniversity@gmail.Com</a></li>
                                <li>Jl. Ketintang No.156, Ketintang, Kec. Gayungan, Surabaya, Jawa Timur</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3  col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="links">
                                ...
                                <li><a href="<?=BASEURL;?>/Web/partner">Kerjasama Pihak Masjid</a></li>
  ...
  Copyright &copy;2024 <a href="https://surabaya.telkomuniversity.ac.id/"><b>Kampus Telkom University Surabaya.</b></a> All rights reserved <!-- | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> -->
